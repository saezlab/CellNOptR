...
resILP = ilpBinaryT1(cnolist = cnolist, model = model, numSolutions = 3, 
                    mipGap = 0.05, relGap = 0.05) # asking to retrieve 3 
...
cutAndPlot(CNOlist = cnolist, model = model, bStrings = resILP$bitstringILP[[2]])
plotModel(model, cnolist, bString=resILP$bitstringILP[[2]])

cutAndPlot(CNOlist = cnolist, model = model, bStrings = resILP$bitstringILP[[3]])
...
\begin{figure*}
\centerline{\includegraphics[width=7cm, height=9cm]{model_1.pdf}}
\caption{Results of the \emph{ilpBinaryT1} function on the Toy Model example - solution 1}
\label{fig:model1}
\end{figure*}

\begin{figure*}
\centerline{\includegraphics[width=7cm, height=9cm]{model_2.pdf}}
\caption{Results of the \emph{ilpBinaryT1} function on the Toy Model example - solution 2}
\label{fig:model2}
\end{figure*}

\begin{figure*}
\centerline{\includegraphics[width=7cm, height=9cm]{model_3.pdf}}
...
\begin{figure*}
\centerline{\includegraphics[width=11cm, height=7cm]{model_3.pdf}}
