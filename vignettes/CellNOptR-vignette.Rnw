...
#
# ---------------------- perform the analysis
resILP = ilpBinaryT1(cnolist = cnolist, model = model, numSolutions = 10, mipGap = 0.05, relGap = 0.05) # asking to retrieve 3 equivalent solutions with tolerance gaps mipGap and relGap 0.05
#
# ---------------------- plot the results
