...
computeScoreT1_BS<-function(CNOlist, model, bString, simList=NULL, indexList=NULL, 
    sizeFac=0.0001, NAFac=1, timeIndex=2, ReorderedBS, counter_BS){
    ...
    Score <- getFit_BS(
        ...
        NAFac=NAFac,
        nInTot=length(which(model$interMat == -1)),
        simResultsT0=simResultsT0,ReorderedBS,counter_BS)
